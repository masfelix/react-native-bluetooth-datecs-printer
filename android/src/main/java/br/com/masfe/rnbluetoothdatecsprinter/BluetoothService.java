...
public class BluetoothService {
    ...
    /*public static final int STATE_LISTEN = 1;//listening -- not implemented */
    public static final int STATE_CONNECTING = 2; // outgoing connection
    ...
    /**
     * Constructor. Prepares a new RNBluetoothDatecsPrinter session.
     *
