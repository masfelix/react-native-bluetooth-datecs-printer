package br.com.masfe.rnbluetoothdatecsprinter.escpos;

import android.graphics.Bitmap;
import android.graphics.BitmapFactory;
import android.util.Base64;
import android.util.Log;
import br.com.masfe.rnbluetoothdatecsprinter.BluetoothService;
import br.com.masfe.rnbluetoothdatecsprinter.BluetoothServiceStateObserver;
import br.com.masfe.rnbluetoothdatecsprinter.escpos.command.sdk.Command;
import br.com.masfe.rnbluetoothdatecsprinter.escpos.command.sdk.PrintPicture;
import br.com.masfe.rnbluetoothdatecsprinter.escpos.command.sdk.PrinterCommand;
...
public class RNBluetoothEscPosPrinterModule  extends ReactContextBaseJavaModule
    ...
    public void printQRCode(String content, int size, int correctionLevel, final Promise promise) {
        try {
            Log.i(TAG, "Texto gerado: " + content);
